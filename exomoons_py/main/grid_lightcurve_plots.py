...
ax_light_list = [ax_light_1,ax_light_2,ax_light_3,ax_light_4,ax_light_5,ax_light_6,ax_light_7,ax_light_8,ax_light_9]
ax_rings_list = [ax_rings_1,ax_rings_2,ax_rings_3,ax_rings_4,ax_rings_5,ax_rings_6,ax_rings_7,ax_rings_8,ax_rings_9]
no_x_list = [ax_rings_1,ax_rings_2,ax_rings_3,ax_rings_4,ax_rings_5,ax_rings_6,ax_rings_7,ax_rings_8,ax_rings_9,ax_light_1,ax_light_2,ax_light_3,ax_light_4,ax_light_5,ax_light_6]
no_y_list = [ax_rings_1,ax_rings_2,ax_rings_3,ax_rings_4,ax_rings_5,ax_rings_6,ax_rings_7,ax_rings_8,ax_rings_9,ax_light_2,ax_light_3,ax_light_5,ax_light_6,ax_light_8,ax_light_9]
...
for i,axis in enumerate(ax_light_list):
    ...
    time_sc, flux_sc, flux_errxx_sc = bring.lightcurve_import(data + '/model' + str(i) + '_scat' + '.dat','sc_deg','sc_light','pseudo_error')
