"""
Data analysis for the light curves. Meaning, I can extract single features and run the test if it is a significant detection.
"""
...
for n in xrange(len(bin_means_1h)-30):
