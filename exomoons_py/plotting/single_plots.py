...
norm_val = bring_disk_sim_data.bring_disk_data(impact,i_deg,phi_deg,"model0",targetdir,str(0),paramfile=True)
...
time_sc, flux_sc, flux_errxx_sc = bring.lightcurve_import(data + '/model' + str(0) + '_scat' + '.dat','sc_deg','sc_light','pseudo_error')
...
bring.plot_1h_sampling(axis,bin_time_1h_sc,flux_tot,new_time,curve_tot,days_side)   # this fills the light curve grids
